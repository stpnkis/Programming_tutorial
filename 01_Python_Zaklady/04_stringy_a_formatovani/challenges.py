...
def vyzva_5(text, stary, novy):
    ...
    """
    return text.replace(stary, novy)
...
Uvnitř {} může být libovolný výraz:
  ...
  f"Velká: {'ahoj'.upper()}" """,
        ...
        tests=[
            lambda: verify(
                vyzva_1("Jan", 25) == "Jmenuju se Jan a je mi 25 let.", "F-string ✓"
            ),
            lambda: verify(
                vyzva_1("Eva", 30) == "Jmenuju se Eva a je mi 30 let.", "Další test ✓"
            ),
        ],
    ),
    Challenge(
  ...
  "Hello World".replace("World", "Python")  → "Hello Python" """,
        ...
        tests=[
            lambda: verify(
                vyzva_5("Hello World", "World", "Python") == "Hello Python", "Replace ✓"
            ),
        ],
    ),
    Challenge(
